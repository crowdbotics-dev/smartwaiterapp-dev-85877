...
## Project Structure
    ...
    ├── smartwaiterapp_dev_85877  # Django project configurations
...
1. Clone this repo and `cd smartwaiterapp_dev_85877`
...
2. Clone this repo and `cd smartwaiterapp_dev_85877`
